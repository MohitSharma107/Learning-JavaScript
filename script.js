...
function yearsUntilRetirement(year, firstName){
  ...
  if(retirement > 0){
      ...
      retirement = retirement.toString().substr(1);
      console.log(firstName, 'retired', retirement, 'years ago');

  }
}

yearsUntilRetirement(1989, 'Dan');
yearsUntilRetirement(1965, 'Bob');
yearsUntilRetirement(1978, 'Jane');
yearsUntilRetirement(1948, 'Jill');
